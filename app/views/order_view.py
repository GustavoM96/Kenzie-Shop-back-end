...
class OrderProductResource(Resource):
    ...
    def get(self, customer_id:int, order_id:int):
        ...
        list_oder = EntityServices.get_all_entity_by_keys(OrderProductModel, order_id=order_id)

        return make_response(jsonify(list_oder), HTTPStatus.OK)
    ...
    def post(self, customer_id:int):
        ...
        parser.add_argument("type_payment", type=str)
